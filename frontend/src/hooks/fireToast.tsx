...
const createToast=(title: string, msg: string, type: number)=>{toast.custom((t) => (
    ...
    <div
      ...
      max-w-md w-full ${type.toString()=='0'?"bg-[#04b20c]":type.toString()=='1'?"bg-[#eab90f]":"bg-[#e13f32]"} shadow-lg rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5`}
    >
