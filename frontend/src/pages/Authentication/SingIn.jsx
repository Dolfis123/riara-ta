...
function SignIn() {
  ...
  return (
    ...
    >
      <Helmet>
        <title>
          Sistem Pengambilan Barang QR - Pengadilan Negeri Manokwari
        </title>
        <meta
          name="description"
          content="Aplikasi resmi Pengadilan Negeri Manokwari untuk pengambilan barang berbasis QR Code. Sistem ini digunakan oleh pegawai melalui proses login yang aman."
        />
      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-900 shadow-xl rounded-2xl p-8">
        <div className="text-center mb-6">
          ...
          <h2 className="mt-4 text-xl font-bold text-gray-800 dark:text-white">
            Sistem Pengambilan Barang Menggunakan QR - Pengadilan Negeri
            Manokwari
          </h2>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-300 text-center">
            Sistem ini ditujukan bagi pegawai Pengadilan Negeri Manokwari untuk
            melakukan pengambilan barang secara cepat dan terverifikasi
            menggunakan QR Code.
          </p>
