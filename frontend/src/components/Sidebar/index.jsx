...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
    pathname === '/data-pegawai' ? 'bg-graydark dark:bg-meta-4' : ''
  }`}
>
  {/* Ikon orang / pegawai */}
  <svg
  ...
  >
    ...
    />
    <path
      d="M20.24 22C20.24 17.58 16.42 14 12 14C7.58001 14 3.76001 17.58 3.76001 22"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
<NavLink
  to="/stok-barang"
  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
    pathname === '/stok-barang' ? 'bg-graydark dark:bg-meta-4' : ''
  }`}
>
  {/* Ikon box/stok barang */}
  <svg
    className="fill-current"
    width="20"
    height="20"
  ...
  >
    <path
      d="M21 16V8M3 8V16M12 22V14M12 2L21 8L12 14L3 8L12 2Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
<NavLink
  ...
  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
    pathname === '/riwayat-pengambilan' ? 'bg-graydark dark:bg-meta-4' : ''
  }`}
>
  {/* Ikon riwayat / waktu */}
  <svg
